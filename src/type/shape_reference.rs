...
impl Display for ShapeReference {
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ShapeReference::ScalarFieldEnum(_, k) => f.write_str(&format!("ScalarFieldEnum<{}>", k.join("."))),
            ShapeReference::ScalarWhereWithAggregatesInput(_, k) => f.write_str(&format!("ScalarWhereWithAggregatesInput<{}>", k.join("."))),
            ShapeReference::CountAggregateInputType(_, k) => f.write_str(&format!("CountAggregateInputType<{}>", k.join("."))),
            ShapeReference::SumAggregateInputType(_, k) => f.write_str(&format!("SumAggregateInputType<{}>", k.join("."))),
            ShapeReference::AvgAggregateInputType(_, k) => f.write_str(&format!("AvgAggregateInputType<{}>", k.join("."))),
            ShapeReference::MaxAggregateInputType(_, k) => f.write_str(&format!("MaxAggregateInputType<{}>", k.join("."))),
            ShapeReference::MinAggregateInputType(_, k) => f.write_str(&format!("MinAggregateInputType<{}>", k.join("."))),
